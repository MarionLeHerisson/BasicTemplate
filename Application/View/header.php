...
<html>
    <head>
        ...
        <meta name="description" content="basic_template">
        <meta name="author" content="basic_template">
        <link rel="icon" href="Medias/basic_template.png">

        <title>basic_template</title>
