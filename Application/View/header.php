...
<html>
    <head>
        ...
        <meta name="description" content="WONDERFUL_WEBSITE DESCRIPTION">
        <meta name="author" content="WONDERFUL_WEBSITE_AUTHOR">
        <link rel="icon" href="Medias/WONDERFUL_WEBSITE_LOGO.png">

        <title>Magnetic Gravity</title>
