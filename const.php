...
if($_SERVER['HTTP_HOST'] == 'localhost') {
    define('BASE_URL', 'localhost' . DIRECTORY_SEPARATOR . 'WONDERFUL_WEBSITE' . DIRECTORY_SEPARATOR);
    define('BASE_PATH', 'C:' . DIRECTORY_SEPARATOR . 'wamp64' . DIRECTORY_SEPARATOR . 'www' . DIRECTORY_SEPARATOR .
        'WONDERFUL_WEBSITE' . DIRECTORY_SEPARATOR);
    define('HOSTNAME', 'localhost');
    define('DBNAME', 'WONDERFUL_WEBSITE_DATABASE_NAME');
    define('DBLOGIN', 'root');
    define('DBPWD', 'root');
